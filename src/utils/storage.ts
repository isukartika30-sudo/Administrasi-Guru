...
const STORAGE_KEYS = {
  ...
  CLASSES: "eduadmin_classes_v1",
  STUDENTS: "eduadmin_students_v1",
  SCHEDULES: "eduadmin_schedules_v1",
  AGENDAS: "eduadmin_agendas_v1",
  JOURNALS: "eduadmin_journals_v1",
  HOMEROOM: "eduadmin_homeroom_v1",
  ASSESSMENTS: "eduadmin_assessments_v1",
  ATTENDANCE: "eduadmin_attendance_v1",
  CPS: "eduadmin_cps_v1",
  TPS: "eduadmin_tps_v1",
